...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/creative/master/_listings/google-doubleclick/userprofiles-profileid-creativefields-id-delete.md
x-common:
