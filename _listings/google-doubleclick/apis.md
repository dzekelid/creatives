...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/creative/master/_listings/google-doubleclick/userprofiles-profileid-creativeassets-advertiserid-creativeassets-post.md
x-common:
